...
Download the data for the zfin_orthology_ingest transform:

```bash
poetry run zfin_orthology_ingest download
```

To run the Koza transform for zfin-orthology-ingest:

```bash
poetry run zfin_orthology_ingest transform
```

To see available options:

```bash
poetry run zfin_orthology_ingest download --help
# or
poetry run zfin_orthology_ingest transform --help
```
